...
class DateTimeModel(BaseModel):
    date: str = Field(description="Properly formatted date in 'DD-MM-YYYY HH:MM' format")
...
class DateModel(BaseModel):
    date: str = Field(description="Properly formatted date in 'DD-MM-YYYY' format")

    @field_validator("date")
    def check_format_date(cls, v):
        # This will validate today's date, e.g., 07-09-2025
